...
function renderCheckout(){
  ...
  <div class="notice payment-instructions">Your total is calculated below. If paying cash, change is available up to $50. If paying Venmo, the link is available by clicking the purple neon Venmo on the previous page, or I can send it to your email/text. Reach out to <strong>ordergottacoffee@gmail.com</strong>!</div>
